        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 my-6 text-center">
                    <img id="team-img-1" src="{{ asset('img/Chairman sir.jpg') }}" alt="টিম সদস্য ১" class="w-full rounded-full mb-4">
                ...
                <!-- টিম সদস্য ২ -->
                <div class="bg-white rounded-lg shadow-md p-6 my-6 text-center">
                    <img src="{{ asset('img/emam.jpg') }}" alt="টিম সদস্য ২" class="w-full rounded-full mb-4">
                ...
                <!-- টিম সদস্য ৩ -->
                <div class="bg-white rounded-lg shadow-md p-6 my-6 text-center">
                    <img src="{{ asset('img/rajon sir new.jpg') }}" alt="টিম সদস্য ৩" class="w-full rounded-full mb-4">
