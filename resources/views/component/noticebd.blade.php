...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <main class="container mx-auto px-4 py-10">
        <div class="text-center mb-12">
            <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-3">নোটিশ বোর্ড</h1>
            <p class="text-gray-600 max-w-2xl mx-auto">সর্বশেষ ঘোষণা এবং গুরুত্বপূর্ণ তথ্যের সাথে আপডেট থাকুন</p>
        </div>
        ...
        @else
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-medium text-gray-600">কোন নোটিশ উপলব্ধ</h3>
                <p class="text-gray-500 mt-2">আপডেটের জন্য পরে আবার দেখুন।</p>
            </div>
        @endif
    </main>
