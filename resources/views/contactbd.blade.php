...
<head>
    ...
    <title>প্রেস্টিজ | যোগাযোগ করুন</title>
...
<body class="bg-gradient-to-br from-gray-100 to-white text-gray-800">
    ...
    <section class="text-center py-16 bg-white text-black">
        <h1 class="text-5xl font-extrabold mb-3">যোগাযোগ করুন</h1>
        <p class="text-lg">আমরা আপনাদের সাথে সংযুক্ত হতে, দিকনির্দেশনা দিতে এবং একসাথে এগিয়ে যেতে প্রস্তুত।</p>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-2xl hover:shadow-green-200 transition duration-300">
                <h2 class="text-3xl font-bold text-green-600 mb-4"><i class="fas fa-building mr-2"></i>প্রধান কার্যালয়</h2>
                <p class="mb-2 text-gray-600"><i class="fas fa-map-marker-alt text-green-400 mr-2"></i> লাখপুর, শিবপুর, নরসিংদী-১৬২০, বাংলাদেশ</p>
                <p class="mb-2 text-gray-600"><i class="fas fa-phone-alt text-blue-400 mr-2"></i> ০১৯৩৭-৫৮৯০৩৬</p>
                <p class="mb-2 text-gray-600"><i class="fas fa-mobile-alt text-blue-400 mr-2"></i> ০১৭১১-৬৭৫৭০৮</p>
            ...
            <div class="bg-white p-8 rounded-3xl shadow-2xl hover:shadow-blue-200 transition duration-300">
                <h2 class="text-3xl font-bold text-blue-600 mb-4"><i class="fas fa-city mr-2"></i>কর্পোরেট কার্যালয়</h2>
                <p class="mb-2 text-gray-600"><i class="fas fa-map-marker-alt text-blue-400 mr-2"></i> নূর মোহাম্মদ খান টাওয়ার (৩য় তলা), জেলখানার মোড়, ডিসি রোড, নরসিংদী সদর, নরসিংদী, বাংলাদেশ</p>
                <p class="mb-2 text-gray-600"><i class="fas fa-phone-alt text-blue-400 mr-2"></i> +৮৮০ ২২২৭৭২১০৮০</p>
