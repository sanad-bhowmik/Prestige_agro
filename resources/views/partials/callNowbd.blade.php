        ...
        <div class="max-w-4xl mx-auto text-center px-4">
            ...
            <div class="inline-block mb-8">
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
                    <span class="relative">
                        <span class="text-green-400">তাৎক্ষণিক</span> সহায়তা দরকার?
                ...
                <p class="text-lg md:text-xl text-gray-300 font-medium max-w-2xl mx-auto">
                    আমাদের বিশেষজ্ঞ দল ২৪/৭ সময় আপনার কৃষি চাহিদার জন্য দ্রুত সহায়তা এবং কাস্টম সমাধান দিতে প্রস্তুত।
                </p>
            </div>
            ...
            <div class="mt-8 text-gray-400">
                <p class="mb-2">অথবা যোগাযোগ করুন:</p>
